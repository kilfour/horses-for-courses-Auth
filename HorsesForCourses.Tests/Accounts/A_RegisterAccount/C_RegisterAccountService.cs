...
public class C_RegisterAccountService : AccountsServiceTests
{
    ...
    {
        await service.Register(TheCanonical.CoachName, TheCanonical.CoachEmail, TheCanonical.Password, TheCanonical.Password, false);
    ...
    public async Task Register_Does_Not_Ship_On_Exception()
    {
        await Assert.ThrowsAnyAsync<DomainException>(async () =>
            await service.Register(TheCanonical.CoachName, TheCanonical.CoachEmail, TheCanonical.Password, "PLOEF", false));
