...
public class C_UpdateSkillsService : CoachesServiceTests
{
    ...
    {
        var response = await service.UpdateSkills(TheCanonical.Actor(), TheCanonical.CoachId, TheCanonical.Skills);
    ...
    public async Task UpdateSkills_calls_update_skills()
    {
        ...
        await service.UpdateSkills(TheCanonical.Actor(), TheCanonical.CoachId, TheCanonical.Skills);
    ...
    public async Task UpdateSkills_Does_Not_Ship_On_Exception()
    {
        ...
        await Assert.ThrowsAnyAsync<DomainException>(
            async () => await service.UpdateSkills(TheCanonical.Actor(), TheCanonical.CoachId, ["a", "a"]));
    ...
    {
        getCoachById.Setup(a => a.One(TheCanonical.CoachId)).ReturnsAsync(spy);
        var success = await service.UpdateSkills(TheCanonical.Actor(), TheCanonical.CoachId, TheCanonical.Skills);
        Assert.True(success);
    }
    ...
    {
        var success = await service.UpdateSkills(TheCanonical.Actor(), TheCanonical.BadId, TheCanonical.Skills);
